...
public class Client {
    ...
    private void doLogin(String host, int port, String username, String password) {
        try {
    ...
    private void sendFile(String recipient, Path path) {
        try {
    ...
    private void receiveFile(Path savePath, long size) throws IOException {
